<%-- 
    Document   : admincustomerdetail
    Created on : Mar 18, 2024, 1:21:04 AM
    Author     : AD
--%>
...
<html>
    ...
    <jsp:include page="component/head.jsp"></jsp:include>
        ...
        <jsp:include page="component/adminheader.jsp"></jsp:include>
            <section>
                <h3 class="text-center text-muted mt-3">Thông tin khách hàng</h3>
                <div class="container py-5">
                <c:set value="${requestScope.customerOrder}" var="c"/>
                <div class="row">
                    <div class="col-lg-4">
